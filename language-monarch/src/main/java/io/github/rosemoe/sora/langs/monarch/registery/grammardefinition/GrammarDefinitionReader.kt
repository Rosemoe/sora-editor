...
abstract class GrammarDefinitionReader<T> : JsonAdapter<GrammarDefinition<T>>() {
    override fun fromJson(reader: JsonReader): GrammarDefinition<T> {
    ...
    override fun toJson(p0: JsonWriter, p1: GrammarDefinition<T>?) {
