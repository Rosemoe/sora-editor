...
import io.github.rosemoe.sora.langs.textmate.AyuDarkColorScheme
import io.github.rosemoe.sora.langs.textmate.LuaLanguage
...
class LspTestActivity : BaseEditorActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ensureTextmateTheme()
        switchThemeIfRequired(this, editor, true)
    ...
    private fun ensureTextmateTheme() {
        ...
        editorColorScheme = AyuDarkColorScheme()
