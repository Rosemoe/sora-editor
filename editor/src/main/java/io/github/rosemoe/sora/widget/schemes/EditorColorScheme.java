...
public class EditorColorScheme {
    ...
    public static final int GHOST_TEXT_FOREGROUND = 81;
     ...
     */
    protected static final int END_COLOR_ID = 81;
    ...
    private void applyDefault(int type) {
        ...
        switch (type) {
            ...
            case TEXT_HIGHLIGHT_BACKGROUND:
                ...
                break;
            case GHOST_TEXT_FOREGROUND:
                color = isDark() ? 0x885A6370 : 0x889AA0A6;
        }
        setColor(type, color);
    }
