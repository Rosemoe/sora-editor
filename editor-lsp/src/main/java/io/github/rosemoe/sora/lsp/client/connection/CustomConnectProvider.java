...
public class CustomConnectProvider implements StreamConnectionProvider {
    ...
    interface StreamProvider {
        /**
         * Called when the connection starts, returning the input stream of the connection
         */
        InputStream getInputStream() throws IOException;

        /**
         * Called when the connection starts, returning the output stream of the connection
         */
