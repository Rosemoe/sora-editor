...
public class ShellDescription implements LanguageDescription {
    ...
    public String[] getKeywords() {
        return new String[]{"echo","read","set","unset","readonly","shift","export","if","fi","else","do","while","done","for","until","continue","exit",
			"esac","case","break","return","trap","wait","eval","exec","ulimit","umask"};
}
